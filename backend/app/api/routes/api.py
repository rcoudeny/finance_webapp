...
router.include_router(
    transaction_category_api.router,
    tags=["transaction_category"],
    prefix=f"{API_PREFIX}/transaction_categorie",
)
router.include_router(
    transaction_category_api.transaction_router,
    tags=["transactions"],
